...
cross_section_2 =           [80, 1.27, 1.27/2;
                            1.27, htall2, 1.27+htall2/2;
                            1.27, htall2, 1.27+htall2/2;
                            5, 1.27, 1.27+htall2-1.27/2;
                            5, 1.27, 1.27+htall2-1.27/2;
                            100, 1.27, 1.27+htall2+1.27/2;
                            100, 1.27, 1.27+htall2+1.27+1.27/2];


cross_section_3 = cross_section_2;
...
Yprofile(1, 201:1001) = htall3+3*1.27;
...
Qcenareas = Asabove(cross_section_2, Yprofile(2,650));
Qcen2 = (dot(Qcenareas(:,1),Qcenareas(:,2)) * (findybar(Qcenareas)- Yprofile(2,650)));
...
%add to profile
Shearprofile(1, 1:1201) = (abs(SFE(1:1201)) * Q1) ./ (Iprofile(1,1) * tabtotal);
...
fish = 0.2;
E = 4000; %N/mm
Diaphragmlos = [1, 101, 201, 301, 401, 501, 601, 701, 801, 901, 1001, 1101, 1201]; %diapharagm locations
